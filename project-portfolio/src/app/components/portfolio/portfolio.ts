...
export class Portfolio {
  ...
  constructor(){
    ...
    this.projectImages = {
      ...
      msbaImmersions: [imageBase+"msba-immersions/molson1.webp",
      ...
      warehouseMap: [imageBase+"warehouse-map/full-warehouse.webp",
      ...
      msbaChallenge: [imageBase+"msba-challenge/eda.webp",
        imageBase+"msba-challenge/justifications.webp",
        imageBase+"msba-challenge/recommendations.webp",
      ],

      woodworking: [imageBase+"woodworking/drawers.webp",
